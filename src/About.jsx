...
// import Button from "./reuseable/Button"; // You can remove this import if you're not using the Button elsewhere
  ...
  return (
    <section className="max-w-[1280px] min-h-[600px] px-16 mx-auto flex justify-between items-center pt-30 pb-20 max-tablet:flex-col-reverse max-tablet:px-8">
      ...
      <div className="w-1/2 px-5 max-tablet:w-full max-tablet:max-w-lg max-tablet:mx-auto max-tablet:px-0 max-tablet:text-center">
        {/* Adjusted heading for direct statement */}
        ...
        {/* --- REVISED ABOUT DESCRIPTION STARTS HERE (No Pronouns, Action Words) --- */}
        ...
        {/* --- REVISED ABOUT DESCRIPTION ENDS HERE --- */}

        {/* Social/CV Icons (This part remains the same) */}
        <div className="flex justify-center max-tablet:justify-center mt-6 space-x-6">
          <a
          ...
          <a
            href="YOUR_CV_LINK_URL"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:scale-110 transition-transform duration-200"
          >
            <img src="cv.png" alt="Download CV" className="w-10 h-10" />
            <p>
              <b>CV</b>
            </p>
          </a>
      ...
      {/* Image Container Div (This part remains the same) */}
      <div className="w-1/3 flex justify-center items-center max-tablet:w-full max-tablet:max-w-sm max-tablet:mx-auto max-tablet:my-10">
        ...
        >
          {/* <div
            className="rounded-tr-4xl rounded-bl-4xl overflow-hidden"
            style={{
              padding: "15px",
              background: "#60a5fa",
            }}
